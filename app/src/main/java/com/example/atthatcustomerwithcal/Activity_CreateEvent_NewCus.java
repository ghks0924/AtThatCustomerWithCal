...
public class Activity_CreateEvent_NewCus extends Activity_Base {

    ImageView backIv, moreIv;
    TextView historyCount, dateTv, timeTv, newTv, retouchTv, okBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_event__new_cus);
