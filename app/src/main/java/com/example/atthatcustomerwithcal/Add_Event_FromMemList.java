...
public class Add_Event_FromMemList extends Activity_Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add__event__from_mem_list);
...
//                dialog.show();
        ...
        timeTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CustomTimePickerDialog timePickerDialog = new CustomTimePickerDialog(Add_Event_FromMemList.this
                    ...
                    if (timeTv.getText().toString().startsWith("예약")) {
                        ...
                        if (!isExistedAlreadyForDateTime) {
                            ...
                            saveEvent(nameTv.getText().toString(), timeTv.getText().toString(), date, monthForSave + "월", year_string
                                    , retouch, 0, false, shortmemoEt.getText().toString(), customer_number,
                                    false, "", "", "" ,"", formatDate);
