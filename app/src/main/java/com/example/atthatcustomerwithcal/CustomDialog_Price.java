...
public class CustomDialog_Price extends Dialog implements View.OnClickListener {
    ...
    public CustomDialog_Price(@NonNull Context context) {
        super(context);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnPositive: //확인 버튼을 눌렀을 때
                ...
                if(editMenu.getText().toString().isEmpty() || editPrice.getText().toString().isEmpty()){


                } else {
                    String name = editMenu.getText().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editMenu = (EditText)findViewById(R.id.menuItemEt);
        editMenu.setHint("시술 종류");
