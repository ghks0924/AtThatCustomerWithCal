...
public class Activity_CreateEvent_OldCus extends Activity_Base {

    ImageView backIv, moreIv;
    TextView loadCusData, historyCount, dateTv, timeTv, newTv, retouchTv, okBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_event_old_cus);
    ...
    public void initLayout() {
        ...
        loadCusData = findViewById(R.id.loadCusData);
        loadCusData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goToActivity(Activity_LoadCustomers.class);
            }
        });
        historyCount = findViewById(R.id.histroy_count_tv);
